const lightTheme = {
  ...
  "wallet-tutorial-check-circle": "url('style/icons/walletTutorialCheckcircle.svg')",
  ...
  "contextbutton-eye-default-icon": "url('style/icons/contextbutton-eye-default.svg')",
