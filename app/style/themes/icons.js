const icons = {
  ...
  "menu-animation-accounts": "url('styles/animations/accountsMotion.gif')",
  "menu-animation-governance": "url('styles/animations/governanceMotion.gif')",
  "menu-animation-help": "url('styles/animations/helpMotion.gif')",
  "menu-animation-overview": "url('styles/animations/overviewMotion.gif')",
  "menu-animation-settings": "url('styles/animations/settingsMotion.gif')",
  "menu-animation-security": "url('styles/animations/securityMotion.gif')",
  "menu-animation-tickets": "url('styles/animations/ticketsMotion.gif')",
  "menu-animation-transactions": "url('styles/animations/transactionsMotion.gif')",
