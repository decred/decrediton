...
## New features 
  ...
  * The new accountless VSP ticket purchasing process has been added as well.
  ...
  split ticket funding transaction, the ticket and the ticket's fee should be
  able to be seen on the overview.  But as you may notice, the ticket's fee
  is not yet broadcast onto the network by the VSP until the ticket has been
  confirmed by 6 blocks.  If any tickets have missing or errored fees, the
  user will be notified if they try to close Decrediton.
