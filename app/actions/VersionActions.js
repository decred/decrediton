    ...
    const getVersion = async () => {
      ...
      try {
        ...
        if (!walletVersion) {
          ...
          versionErr = `API versions not compatible.. Decrediton requires ${requiredVersion} but wallet ${walletVersion} does not satisfy the requirement.
            Please check your installation, Decrediton and Dcrwallet versions should match.`;
        }
        if (versionErr) {
