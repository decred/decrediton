...
export const getVersionServiceAttempt = () => (dispatch, getState) => new Promise(async (resolve, reject) => {
...
export const getWalletRPCVersionAttempt = () => (dispatch, getState) => new Promise(async (resolve,reject) => {
