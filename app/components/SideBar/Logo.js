...
const Logo = ({ isTestNet, expandSideBar, onReduceSideBar, onExpandSideBar, isWatchingOnly, accountMixerRunning }) => (
  <div className={expandSideBar ? "sidebar-logo" : "reduced-sidebar-logo"} onClick={!expandSideBar ? onExpandSideBar : null}>
    ...
    {
      accountMixerRunning &&
      <Tooltip text={<T id="sidebar.mixer.running" m="The mixer is running. Go to Privacy view for more information" /> } >
