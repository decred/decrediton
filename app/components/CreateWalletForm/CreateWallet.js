  ...
  <div className="page-content new-seed">
    <div className="help-text">
      <div className="paragraph left">
        <FormattedMessage id="createWallet.info" defaultMessage={`
        ...
        <span className="cyan-bold">
          <FormattedMessage id="creteWallet.writeSeedReminder" defaultMessage="Write down the following seed and save it in a secure location."/>
        </span>
        <br/>
        <br/>
        <span className="cyan-regular">
          <FormattedMessage id="createWallet.nextPromptSeed" defaultMessage="The next prompt will require entering this seed to confirm it has been saved."/>
        </span>
      </div>
      <div className="paragraph right">
        <FormattedMessage id="createWallet.lossInfo" defaultMessage={`
          ...
          `}
          values={{
            warningNotice: <span className="orange-warning"><FormattedMessage id="createWallet.warningNotice" defaultMessage="Warning"/></span>
          }}
        />
      </div>
    </div>
    ...
    <KeyBlueButton className="wallet-key-blue-button" onClick={createWalletConfirmNewSeed}>
      <FormattedMessage id="createWallet.continueBtn" defaultMessage="Continue" />
    </KeyBlueButton>
  </div>
);
