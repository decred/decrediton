  ...
  <>
    <div key={key} className="backup-redeem-script-message">
      <T id="backup.redeem.script.message"
        ...
        values={{ warnMessage: <span className="error bold"><T id="backup.redeem.script.warn" m="your funds may be lost forever." /></span> }}/>
    </div>
    <div className="backup-redeem-script-title"><T id="backup.redeem.script.title" m="Script" /></div>
    <textarea disabled value={script} className="backup-redeem-script-textarea" />
  </>
);
