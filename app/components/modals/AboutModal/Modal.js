    ...
    <div className="about-modal-bottom-area">
      <div className="about-modal-bottom-area-left">
        ...
        {updateAvailable ?
          ...
          <a className="about-modal-upgrade" onClick={() => shell.openExternal("https://github.com/decred/decred-binaries/releases/tag/v1.3.0")}><T id="aboutModal.whatsNew" m="What's New?"/></a> }
      </div>
