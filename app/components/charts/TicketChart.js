...
const BalanceChart = ({ data, currencyDisplay }) => (
    <BarChart width={400} height={244} data={data}>
        ...
        <Legend />
        <Bar barSize={8} dataKey="imature" stackId="a" fill="#69d5f7" radius={[10, 10, 10, 10]} unit={currencyDisplay} />
        <Bar barSize={8} dataKey="live" stackId="a" fill="#2971ff" radius={[10, 10, 10, 10]} unit={currencyDisplay} />
        <Bar barSize={8} dataKey="voted" stackId="a" fill="#2ed7a2" radius={[10, 10, 10, 10]} unit={currencyDisplay} />
    </BarChart>
);
