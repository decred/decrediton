...
function ConfigMixer({
  ...
  return (
    <>
      <Subtitle title={<T id="privacy.config.subtitle" m="Privacy Configuration" />} />
                ...
                <WatchOnlyWarnNotification isActive={isCreateAccountDisabled}>
                  <PassphraseModalButton
                    {...{
                      ...
                      setChangeAccountName, isValid
                    }}
                    disabled={isCreateAccountDisabled}
                    modalTitle={<T id="accounts.defaultAccountConfirmations" m="Create default accounts" />}
                    buttonLabel={<T id="accounts.createDefaultAcc" m="Create default Accounts" />}
                  />
            ...
            <>
              ...
              <WatchOnlyWarnNotification isActive={isCreateAccountDisabled}>
                <PassphraseModalButton
                  ...
                  disabled={isCreateAccountDisabled}
                  modalTitle={<T id="accounts.createNeededAcc" m="Create Needed Accounts" />}
                  modalComponent={AddMixerAccountsModal}
                  buttonLabel={<T id="accounts.createNeededAcc" m="Create Needed Accounts" />}
                />
              </WatchOnlyWarnNotification>
            </>
          )
