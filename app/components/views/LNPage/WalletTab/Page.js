  ...
  <div className={styles.balanceHeader}>
    ...
    <div
      className={classNames(
        styles.balanceTile,
        totalBalance === 0 ? styles.zeroFunds : null
      )}>
      <div className={styles.balanceValue}>
...
export default ({
  ...
  <>
    ...
    <div className={styles.backupPanel}>
      ...
      <BackupInfoDetails onBackup={onBackup} onVerifyBackup={onVerifyBackup} />
    </div>
    ...
    <ConfirmModal
      ...
      modalTitle={
        <T id="ln.confirmBackupOverwrite.title" m="Confirm Backup Overwrite" />
      }
      modalContent={
        <>
          <T
