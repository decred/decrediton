...
const PurchaseTicketsAdvanced = ({ stakePool, ticketFee, txFee, expiry }) => (
  <div className="stakepool-purchase-ticket-quick-bar">
    <Tooltip
      text={<T id="purchaseTickets.currentStakepool" m="Current VSP" />}
    ...
    <Tooltip
      text={<T id="purchaseTickets.expiry" m="Expiry" />}
    ...
    <Tooltip
      text={<T id="purchaseTickets.ticketFeeTip" m="Ticket Fee" />}
    ...
    <Tooltip
      text={<T id="purchaseTickets.txFeeTip" m="Tx Fee" />}
    ...
    <Tooltip
      text={<T id="purchaseTickets.ticketAddress" m="Ticket Address" />}
