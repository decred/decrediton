...
m="Purchase Tickets is not available right now, because we are in the beginning of a ticket interval. After {blocksNumber} blocks it will be available again."values={{blocksNumber: blocksNumber}}
/>;
const Tickets = ({
  spvMode,
