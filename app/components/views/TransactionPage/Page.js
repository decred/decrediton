...
const Page = ({
  transactionDetails, tsDate, decodedTransaction, currentBlockHeight, intl, goBackHistory, publishUnminedTransactions
}) => {
  const {
    txHash,
    txUrl,
...
export default transactionDetails(injectIntl(Page));
