    ...
    <div className={styles.text}>
      ...
      <div>
        <T
          ...
          m="Once the majority of the PoW miners have upgraded (95% of the 100 most recent blocks are at the latest version) and the majority of the PoS miners have upgraded (75% of the votes in a 2016 block interval), the voting process begins."
        />
      </div>
    </div>
  </div>
