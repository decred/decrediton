...
export default ({
  onSendBack, version, docName, imgClassName, onNewerVersion, onOlderVersion
}) => (
  <>
    <div className="content-title">
      <div className="go-back-screen-button-area">
        <Tooltip text={ <T id="releaseNotes.goBack" m="Go back" /> }><div className="go-back-screen-button" onClick={onSendBack}/></Tooltip>
      </div>
