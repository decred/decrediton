...
export default function notifications(state = {}, action) {
  switch (action.type) {
    ...
    case TRANSACTIONNTFNS_END:
      return { ...state, transactionNtfns: null, transactionNtfnsError: null };
    case ACCOUNTNTFNS_START:
      return { ...state, accountNtfns: action.accountNtfns };
    case ACCOUNTNTFNS_DATA:
      return { ...state, accountNtfnsResponse: action.response };
    case ACCOUNTNTFNS_END:
      return { ...state, accountNtfns: action.null };
    case CLEARUNMINEDMESSAGE:
      return { ...state, newUnminedMessage: null };
    default:
      return state;
  }
}
