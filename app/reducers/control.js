import { GETNEXTADDRESS_ATTEMPT, GETNEXTADDRESS_FAILED, GETNEXTADDRESS_SUCCESS,
  ...
  STOPTICKETBUYERV2_ATTEMPT, STOPTICKETBUYERV2_SUCCESS, CONSTRUCTTX_ATTEMPT,
  CONSTRUCTTX_FAILED, CONSTRUCTTX_SUCCESS, CONSTRUCTTX_FAILED_LOW_BALANCE,
  SETBALANCETOMAINTAIN, VALIDATEADDRESS_ATTEMPT, VALIDATEADDRESS_SUCCESS,
  VALIDATEADDRESS_FAILED, VALIDATEADDRESS_CLEANSTORE, MODAL_SHOWN, MODAL_HIDDEN,
  SHOW_ABOUT_MODAL_MACOS, HIDE_ABOUT_MODAL_MACOS, VALIDATEMASTERPUBKEY_SUCCESS, VALIDATEMASTERPUBKEY_FAILED,
  GETACCOUNTEXTENDEDKEY_ATTEMPT, GETACCOUNTEXTENDEDKEY_FAILED, GETACCOUNTEXTENDEDKEY_SUCCESS,
  HIDE_AUTOBUYER_RUNNING_MODAL, SHOW_AUTOBUYER_RUNNING_MODAL
...
export default function control(state = {}, action) {
  ...
  case SHOW_AUTOBUYER_RUNNING_MODAL:
    return { ...state,
      autobuyerRunningModalVisible: true
    };
