      ...
      outputs: [
        {
          ...
          decodedScript: {
            ...
            address: null,
            requiredSig: 0,
            asm: "OP_RETURN OP_DATA_36 e4d5021f882b7926497679f68b14dbf77fdd2a901b24560ab297789e00000000803b0e00"
          }
        },
        {
          value: 0,
        ...
        },
        {
          ...
          decodedScript: {
            ...
            requiredSig: 1,
            asm: "OP_SSGEN OP_DUP OP_HASH160 OP_DATA_20 99bf7a5e99c8c00e09ecef371eabd7865bcf5e11 OP_EQUALVERIFY OP_CHECKSIG"
          }
        }
      ],
      lockTime: 0,
      ...
      outputs: [
        {
          ...
          decodedScript: {
            ...
            requiredSig: 1,
            asm: "OP_SSRTX OP_DUP OP_HASH160 OP_DATA_20 c0e4b3a5b5a454e388c6864ae51205223a12dce4 OP_EQUALVERIFY OP_CHECKSIG"
          }
        }
      ],
      lockTime: 0,
      ...
      outputs: [
        {
          ...
          decodedScript: {
            ...
            address: null,
            requiredSig: 0,
            asm: "OP_RETURN OP_DATA_36 32c8b01145a24d62ff8db613ca24a3b92e2472bac893ad0e864f1c8b00000000a8090e00"
          }
        },
        {
          value: 0,
        ...
        },
        {
          ...
          decodedScript: {
            ...
            requiredSig: 1,
            asm: "OP_SSGEN OP_DUP OP_HASH160 OP_DATA_20 53b208495f9fabdfa80b4be10c4d0e488b33f299 OP_EQUALVERIFY OP_CHECKSIG"
          }
        }
      ],
      lockTime: 0,
